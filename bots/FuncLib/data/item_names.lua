return {
	...
	{sRawName='item_essence_distiller', sShortName='itemNull', sCnName='精之灵器', sEnName='Essence Distiller'},
	{sRawName='item_specialists_array', sShortName='itemNull', sCnName='行家阵列', sEnName="Specialist's Array"},
	{sRawName='item_hydras_breath', sShortName='itemNull', sCnName='怪蛇之息', sEnName="Hydra's Breath"},
	{sRawName='item_consecrated_wraps', sShortName='itemNull', sCnName='圣化护服', sEnName='Consecrated Wraps'},
	{sRawName='item_crellas_crozier', sShortName='itemNull', sCnName='克莱拉牧杖', sEnName="Crella's Crozier"},
	-- 7.41 new/returning neutral items
	{sRawName='item_dagger_of_ristul', sShortName='itemNull', sCnName='瑞斯图尔尖匕', sEnName='Dagger of Ristul'},
	{sRawName='item_foragers_kit', sShortName='itemNull', sCnName='采菌套具', sEnName="Forager's Kit"},
	{sRawName='item_stonefeather_satchel', sShortName='itemNull', sCnName='石羽小包', sEnName='Stonefeather Satchel'},
	...
	{sRawName='item_ash_legion_shield', sShortName='itemNull', sCnName='余烬军团战盾', sEnName='Ash Legion Shield'},
	{sRawName='item_duelist_gloves', sShortName='itemNull', sCnName='决斗者手套', sEnName='Duelist Gloves'},
	{sRawName='item_poor_mans_shield', sShortName='itemNull', sCnName='穷鬼盾', sEnName="Poor Man's Shield"},
	{sRawName='item_defiant_shell', sShortName='itemNull', sCnName='坚抗之壳', sEnName='Defiant Shell'},
	{sRawName='item_seeds_of_serenity', sShortName='itemNull', sCnName='宁静种籽', sEnName='Seeds of Serenity'},
	...
	{sRawName='item_partisans_brand', sShortName='itemNull', sCnName='天游烙印', sEnName="Partisan's Brand"},
	{sRawName='item_jidi_pollen_bag', sShortName='itemNull', sCnName='基迪花粉袋', sEnName='Jidi Pollen Bag'},
	{sRawName='item_serrated_shiv', sShortName='itemNull', sCnName='锯齿短刀', sEnName='Serrated Shiv'},
	{sRawName='item_gunpowder_gauntlets', sShortName='itemNull', sCnName='火药手套', sEnName='Gunpowder Gauntlets'},
	{sRawName='item_unrelenting_eye', sShortName='itemNull', sCnName='不懈之眼', sEnName='Unrelenting Eye'},
	...
	{sRawName='item_idol_of_screeauk', sShortName='itemNull', sCnName='斯奎欧克之像', sEnName="Idol of Scree'auk"},
	{sRawName='item_flayers_bota', sShortName='itemNull', sCnName='剥皮者之靴', sEnName="Flayer's Bota"},
	{sRawName='item_metamorphic_mandible', sShortName='itemNull', sCnName='变态上颚', sEnName='Metamorphic Mandible'},
	{sRawName='item_dandelion_amulet', sShortName='itemNull', sCnName='蒲公英护符', sEnName='Dandelion Amulet'},
	{sRawName='item_enchanters_bauble', sShortName='itemNull', sCnName='附魔师之椟', sEnName="Enchanter's Bauble"},
	{sRawName='item_prophets_pendulum', sShortName='itemNull', sCnName='先知灵摆', sEnName="Prophet's Pendulum"},
	{sRawName='item_conjurers_catalyst', sShortName='itemNull', sCnName='咒术师触媒', sEnName="Conjurer's Catalyst"},
	{sRawName='item_dezun_bloodrite', sShortName='itemNull', sCnName='戴尊血仪', sEnName='Dezun Bloodrite'},
	{sRawName='item_divine_regalia', sShortName='itemNull', sCnName='神圣宝饰', sEnName='Divine Regalia'},
	{sRawName='item_riftshadow_prism', sShortName='itemNull', sCnName='影墟棱晶', sEnName='Riftshadow Prism'},
	{sRawName='item_harmonizer', sShortName='itemNull', sCnName='协和', sEnName='Harmonizer'},
	{sRawName='item_crippling_crossbow', sShortName='itemNull', sCnName='致残之弩', sEnName='Crippling Crossbow'},
