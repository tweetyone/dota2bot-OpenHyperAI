...
local AttackingWards = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/attacking_wards')
local PrimalSplit = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/primal_split')
local Familiars = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/familiars')
local Illusion = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/illusions')
local MinionWithSkill = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/minion_with_skill')
local VengefulSprit = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/vengeful_spirit')
local Jugg = dofile(GetScriptDirectory()..'/FuncLib/hero/minion_lib/jugg')
