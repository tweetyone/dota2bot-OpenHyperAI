...
function X.ConsiderCrystalNova()
	...
	local nCastRange = Fu.GetProperCastRange(false, bot, CrystalNova:GetCastRange())
...
function X.ConsiderFrostbite()
	...
	local nCastRange = Fu.GetProperCastRange(false, bot, Frostbite:GetCastRange())
...
function X.ConsiderCrystalClone()
	...
	then
		...
		and Fu.IsInRange(bot, botTarget, nRange - 150)
